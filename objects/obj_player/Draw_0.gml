...
//draw charge bar
if (state = state_charging) or (state = state_bouncing and key_pickup_1) {
	...
	draw_sprite_ext(spr_player_zekai_charging_red,image_index,x,y,image_xscale,image_yscale,image_angle,c_white,(charge/charge_max)*0.7 + 0.1);
}
