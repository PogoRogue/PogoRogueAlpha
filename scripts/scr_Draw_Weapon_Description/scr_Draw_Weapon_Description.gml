...
function scr_Draw_Weapon_Description(xx,yy,weapon,weapon_num) {
	...
	draw_text_color(xx+26,yy-105,scr_Linebreak(weapon._name,16,99),white,white,white,white,1);
	
	//Weapon Description
	draw_set_halign(fa_left);
	draw_set_valign(fa_top);
	draw_set_font(fnt_itemdescription2);
	scr_Draw_Text_Outlined(xx-72,yy-84,scr_Linebreak(weapon.tagline,28,99),c_white);
	...
	draw_set_halign(fa_center);
	draw_set_valign(fa_center);
	draw_text_color(xx+1,yy+6,line_1,white,white,white,white,1);
	draw_text_color(xx+1,yy+38,line_2,white,white,white,white,1);
	draw_text_color(xx+1,yy+70,line_3,white,white,white,white,1);
	draw_text_color(xx+1,yy+102,line_4,white,white,white,white,1);
}